---
title: Leading through challenging times
author: Sally
type: post
...
categories:
  - leadership
headerimg: '/img/content/blog/20260326-hdr.jpg'
---


<p class="lede">In my career I’ve seen a wide range of what could generically be considered “challenging times”: layoffs, a pandemic, complete C-suite overhauls, political instability and wars, reorgs and strategic U-turns, and more.</p> 
...
<div class="callout">
  ...
  <p class="callout-text">Note that I also offer a workshop version of this post, to run with teams and leaders facing challenges – please get in touch for more information</p>
</div>
...
By using tools such as the Feelings Wheel (version [here by Calm](https://www.calm.com/blog/the-feelings-wheel)) you can work through and assess the nuances. Maybe you’re feeling fearful for the future, but by drilling deeper into understanding that driving this is that you’re feeling ’overwhelmed’, it can help you take more tailored action than if for example you were feeling ‘inferior’ or ‘inadequate’.

<figure>
<img src="/img/content/blog/20260326-wheel.jpg" alt="The centre of the linked Feelings Wheel, showing the primary emotion, and a cut down list of the second and tertiary ones" />
<figcaption><a href="https://www.calm.com/blog/the-feelings-wheel">Feelings Wheel</a>, Calm</figcaption>
</figure>
...
A useful visualisation for typical stages of emotion is the [**Kübler-Ross Change Curve**](https://www.ekrfoundation.org/5-stages-of-grief/change-curve/), which is builds on the model of the five stages of grief – denial, anger, bargaining, depression and acceptance. Whilst the below is a typical process, in reality everyone’s experience will be slightly different.

<figure>
<img src="/img/content/blog/20260326-changecurve.png" alt="The centre of the linked Feelings Wheel, showing the primary emotion, and a cut down list of the second and tertiary ones" />
<figcaption><a href="https://www.ekrfoundation.org/5-stages-of-grief/change-curve/">Kübler-Ross Change Curve</a>, Dr. Elisabeth Kübler-Ross</figcaption>
</figure>
...
When it comes to the workplace, a very useful reference is [BICEPS by Paloma Medina](https://www.palomamedina.com/biceps/). In this, Medina outlines how **Belonging, Improvement, Choice, Equality/ Fairness, Predictability, and Significance** impact on us. 
...
- How do your patterns around food/water/sleep/hobbies/head space
compare to normal?
- What would you normally be doing to unwind? How does the current situation
differ, and what’s the impact on you?
- In normal times what gives you energy, and what drains you? How much of
each are you getting at the moment?
- When did you last take holiday, and how long for? Are you running on empty
even before this challenge?
- What are you finding difficult to do? How does this compare to what you
...
- What can you commit to doing tomorrow that’ll make it better than
today?
...
<figure>
<img src="/img/content/blog/20260326-spongebob-panic.gif" alt="Gif of SpongeBob and Patrick running around in a panic" />
</figure>
</div>
...
- Set out your expectations of the team – is everything carrying on as normal and all previous deadlines stand? Will there be an org-wide break for people to process? What is changing and what isn’t?
    ...
    - Encouraging people to do a [calendar defrag](https://sallylait.com/blog/2019/08/27/calendar-defrags/) in line with any changing priorities, making sure there’s enough time, space, and positive energy to focus on the most impactful tasks.
...
- [Calm](https://www.calm.com/), an app for sleep, meditation, and relaxation
- https://www.cipd.org/uk/knowledge/guides/mental-health-support-guide/
- [Workplace mental health manager guides](https://www.bupa.co.uk/business/workplace-wellbeing-hub/mental-health-in-the-workplace/manager-guides)
- [The Feelings Wheel](https://www.calm.com/blog/the-feelings-wheel), Calm
- [Kübler-Ross Change Curve](https://www.ekrfoundation.org/5-stages-of-grief/change-curve/)
- [Understanding the Kübler-Ross Change Curve in the Workplace](https://www.indeed.com/career-advice/career-development/change-curve)
- [BICEPS by Paloma Medina](https://www.palomamedina.com/biceps/)
- [Lara Hogan - Resources for leading through crises](https://larahogan.me/blog/resources-leading-through-crises/)
    - [Being a manager in terrible times](https://larahogan.me/blog/being-a-manager-in-terrible-times/)
    - [Easy check-in questions for your 1:1s during times of crisis](https://larahogan.me/blog/check-in-questions-for-one-on-ones-during-crisis/)